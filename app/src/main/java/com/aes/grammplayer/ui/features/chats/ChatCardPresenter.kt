...
class ChatCardPresenter : Presenter() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, item: Any?) {
        ...
        val spannable = SpannableStringBuilder().apply {
            ...
            val tStart = this.length
            append(chatTypeReadable.toString())
            val tEnd = this.length
            setSpan(StyleSpan(Typeface.BOLD), tStart, tEnd, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
     ...
     */
    class ChatCardViewHolder(view: View, val textView: TextView) : ViewHolder(view)
