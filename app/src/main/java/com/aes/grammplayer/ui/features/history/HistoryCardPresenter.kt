...
class HistoryCardPresenter : Presenter() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, item: Any?) {
        ...
        view.findViewById<TextView>(R.id.title).text = message.title.ifEmpty { "Untitled" }
        ...
        bindThumbnail(view, message)
    }

    private fun bindThumbnail(view: View, message: com.aes.grammplayer.db.model.MediaMessage) {
        ...
        val thumbnailPath = message.thumbnailPath
        val readyPath = when {
